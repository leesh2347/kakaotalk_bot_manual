  ...
  return (
    <article>
      <header>
        ...
        <p><br /><span style={{ color: '#FA5858' }}>※일부 방에서는 방장의 개발자에게 요청으로 인해 작동하지 않습니다. 도움말에 링크된 도배방을 이용해 주세요.</span></p>
