  ...
  return (
    <article>
      ...
      <section>
        ...
        <p>● 원활한 작동을 위해 오전, 오후 각 12 시 02 분 마다 봇이 리로드 됩니다.</p>
        <p>● 방장의 요청 하에 일부 방에서는 '재미요소' 카테고리의 기능들은 작동하지 않습니다. 도배방에 입장하여 사용하시면 됩니다.</p>
        <p>● 루시봇은 개인 기기를 서버로 사용하여 구동하고 있으므로 과부하 등 기기 사정에 따라 봇이 느려지거나 멈출 수 있습니다. 기기를 주인장 사무실에 보관하고 있으므로 주인장이 바쁘거나, 출근하지 않을 경우 문제 해결이 지연될 수 있습니다.</p>
        <p>● 카카오톡 봇은 안드로이드 공기계를 서버로 사용합니다. 때문에 안드로이드의 배터리 최적화 정책으로 인해 봇 프로세스가 간헐적으로 죽는 문제가 있어, 현재까진 온전한 해결 방안은 없으므로 양해 부탁드립니다.</p>
        <p>● 봇이 며칠 동안 작동하지 않을 경우 주인에게 문의를 주시면 기기 재부팅을 시켜드립니다. 단, 상술하였듯 간헐적으로 하루 정도 멈추는 현상은 해결 방법이 없으므로 가급적이면 며칠 이상 아예 동작하지 않을 때만 재부팅 요청을 부탁드립니다.</p>
        <p>● 봇 사용 중 버그 등 문제 발생 시 제작자에게 문의 주시면 됩니다. 가능한 볼 때마다 성실히 대답해 드리며, 버그도 최대한 고쳐드리겠습니다.</p>
        <p>● (2023.5.22~) 카카오링크 (사진 출력) 기능은 카카오톡 측의 패치로 구현이 어려워져 루시봇은 일반적인 텍스트 출력만을 사용합니다.</p>
        <p>● 추가를 원하는 기능이 있을 시 제작자에게 문의해 주세요.</p>
        <p>● 서버 기기 사정상 현재는 신규 방 영입은 받지 않고 있습니다. 다만 기존 방에서의 내보내기 등으로 빈자리가 생길 시 신규 영입을 받으며, 이 경우 봇 주인장이 공지해 줍니다.</p>
        <p>● (2025.02.13~) 신기능 업데이트, 신규 방 영입 가능 여부 등은 도배방에서 전체공지로 알려줍니다.</p>
      ...
      <section>
        <h2>
          <a href="https://github.com/leesh2347">
            <span style={{ color: '#2E9AFE', fontSize: '25px' }}>▶ 기타</span>
          </a>
        </h2>
